...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (str.length() > 3 || str.length() < 1 || str.equals("")) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(MainActivity.this);
                    builder.setTitle("Vorsicht")
                            .setMessage("Kennzeichen in Deutschland bestehen nur aus maximal 3 Buchstaben.")
                            .setCancelable(false)
    ...
    private void addAllListEntries() {
        String[][] array = new String[][]{
                ...
                {"AK",
                        "Altenkirchen(Westerwald) in Rheinland-Pfalz"},

                {"ALF",
                        "Alfeld(Leine) in Niedersachsen"},
